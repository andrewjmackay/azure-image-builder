write-host 'AIB Customization: Executing RemoveBuiltInApps.ps1'

Begin {
    # White list of Features On Demand V2 packages
    $WhiteListOnDemand = "NetFX3|Tools.DeveloperMode.Core|Language|InternetExplorer|ContactSupport|WindowsMediaPlayer|Hello.Face|Notepad|ShellComponents"
...
write-host 'AIB Customization: Finished Executing RemoveBuiltInApps.ps1'